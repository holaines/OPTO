...
#figure(
  image(img_path + "circuito.jpeg", width: 70%),
...
#figure(
  image(img_path + "micro analogico mer e ines.jpeg", width: 65%),
...
#figure(
  image(img_path + "primer micro mer e ines CON TODO EL CIRCUITO.jpeg", width: 75%),
