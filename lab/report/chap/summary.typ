...
#figure(
  table(
    ...
    [Completed],
    [The INA131 conditioning circuit was implemented and tested with an analog MEMS microphone. The circuit amplified the microphone signal correctly.],
  ...
  caption: [Laboratory objectives summary]
)
